...
import com.example.springbootcache.service.CacheConfig;
...
public interface AchBankRepo extends JpaRepository<AchBankEntity, String> {
    ...
    @Cacheable(value = CacheConfig.BIC_CODE, key = "#benId" , unless="#result == null" , cacheManager = "bankCacheManager")
    ...
    @Cacheable(value = CacheConfig.BEN_ID , key = "#binId" , unless="#result == null" , cacheManager = "bankCacheManager")
    ...
    @Cacheable(value = CacheConfig.BANK_ID , key = "#bicCode" , unless="#result == null" , cacheManager = "alternateCacheManager")
